create
    definer = ebroot@`%` procedure prepareDailyVulnerabilities(IN start_date timestamp, IN end_date timestamp, OUT cveCount int)
BEGIN
    SET session group_concat_max_len=1000000;
    TRUNCATE TABLE vulnerabilityaggregate;
    INSERT INTO vulnerabilityaggregate(
        ...
        FROM (SELECT vu.vuln_id,
              ...
              WHERE drh.run_date_time BETWEEN start_date AND end_date
