...
public class DatabaseHelperTest {
    ...
    public void testInsertPatchSourceURL() {
        ...
        int sourceId = databaseHelper.insertPatchSourceURL(TEST_CVE_ID, sourceURL);
    ...
    public void testInsertPatchCommit() {
        ...
        databaseHelper.insertPatchCommit(sourceId, sourceURL, commitId, commitDate, commitMessage, uniDiff, timeLine, timeToPatch, linesChanged);
