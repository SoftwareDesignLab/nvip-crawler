...
public class archivedDatabaseHelper {

    private HikariConfig config = null;
    private HikariDataSource dataSource;
    private static final Logger logger = LogManager.getLogger(archivedDatabaseHelper.class.getSimpleName());
    private static final String databaseType = "mysql";
    private static archivedDatabaseHelper databaseHelper = null;
    ...
    public static synchronized archivedDatabaseHelper getInstance() {
        if (databaseHelper == null) {
            HikariConfig config = createHikariConfigFromEnvironment();
            databaseHelper = new archivedDatabaseHelper(config);
        }
        return databaseHelper;
    }

    public static synchronized archivedDatabaseHelper getInstance(String url, String username, String password)  {
        if (databaseHelper == null) {
    ...
    protected archivedDatabaseHelper(HikariConfig config) {
        try {
